    ...
    >
      ...
      <aside class="w-1/3 bg-gray-200 p-6 pb-12">
        ...
        <div class="mb-4">
          ...
          <input
            type="text"
            class="new-firstname mt-1 block w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            placeholder="Alex"
          />
        </div>
        <div class="mb-4">
          ...
          <input
            type="text"
            class="new-lastname mt-1 block w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            placeholder="Doe"
          />
        </div>
        <div class="mb-4">
          ...
          <input
            type="email"
            class="new-email mt-1 block w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
            placeholder="alex.doe@gmail.com"
          />
        </div>
        <button
          class="add-btn w-full bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md"
        >
          Add
        </button>
      </aside>
      ...
      <section class="w-2/3 p-6">
        <div class="flex justify-between items-center mb-4">
          ...
          <p class="text-gray-600 mb-4">
            Contacts Count : <span class="counter font-bold"></span>
          </p>
        </div>
